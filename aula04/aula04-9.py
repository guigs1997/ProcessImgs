...
from matplotlib import pyplot as plt #mostrar várias imagens numa janela
...
plt.subplot(2,3,1),plt.imshow(img1,'gray'),plt.title('ORIGINAL') #tamanho do plot (duas linhas e tres colunas, na casa 1)
